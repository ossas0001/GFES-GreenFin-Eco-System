/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6e86ea61dbca976c009cf340588f227c)
// Runtime types generated with workerd@1.20260515.1 2026-05-22 nodejs_compat
interface __BaseEnv_Env {
	UPLOADS: R2Bucket;
	DB: D1Database;
	IMAGES: ImagesBinding;
	GOOGLE_REDIRECT_URI: "https://gfes-greenfin-eco-system.crypto-magician.workers.dev/api/auth/google/callback";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_REDIRECT_URI">> {}
}
